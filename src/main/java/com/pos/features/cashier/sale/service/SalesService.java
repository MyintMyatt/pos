...
import com.pos.features.cashier.sale.util.SaleMapper;
...
public class SalesService {
    ...
    private final SalesTaxRepo salesTaxRepo;
    private final UserService userService;
    private final MenuService menuService;
    private final TaxService taxService;
    private final MenuItemDiscountRepository menuItemDiscountRepository;
    ...
    public SalesResponse createSale(SalesRequest request) {
        ...
        * */
        User createdBy = userService.getUser(securityService.getCurrentLoginUserId());
        ...
        return saleMapper.toResponse(sales);
    }
    ...
    public PageDTO<SalesResponse> getAllSales(int page, int size, String keyword, LocalDate startDate, LocalDate endDate) {
        ...
        List<SalesResponse> content = salesPage.stream().map(saleMapper::toResponse).toList();
